          ...
          dataPart1.map(function(data, i) {
            ...
            return <div key={i}>
              <Row style={{textAlign : "center", margin : "2em 0"}}>
                Question {141 + 3 * i} - {141 + 3 * i + 2} refer to following conversation:
              </Row>
              <Row>
                {data.paragraph}
              </Row>
              <Row>
                <b>{140 + 3 * i + 1}. {data.subQuestions[0].question}</b>
              </Row>
              <Row>
                <Radio.Group onChange={(e) => onChange(e.target.value, 3 * i)} defaultValue={userAnswer[3 * i]}>
              ...
              <Row>
                <b>{140 + 3 * i + 3}. {data.subQuestions[1].question}</b>
              </Row>
              <Row>
                <Radio.Group onChange={(e) => onChange(e.target.value, 3 * i + 1)} defaultValue={userAnswer[3 * i + 1]}>
                  <Radio style={radioStyle} value={"a"}>
              ...
              <Row>
                <b>{140 + 3 * i + 3}. {data.subQuestions[2].question}</b>
              </Row>
              <Row>
                <Radio.Group onChange={(e) => onChange(e.target.value, 3 * i + 2)} defaultValue={userAnswer[3 * i + 2]}>
                  <Radio style={radioStyle} value={"a"}>
