  ...
  <div className={`${prefixCls}`}> 
    <div className={`${prefixCls}-content`}>
      <div className="" style={{marginTop : "4em", padding : "3em 8em"}}>
        ...
        </Row>
        {
          ["","","",""].map(function(data, i) {
            return <div>
              ...
              <Row>
                <b>{140 + 3 * i + 1}. Select the answer</b>
              </Row>
              <Row>
              ...
              <Row>
                <b>{140 + 3 * i + 3}. Select the answer</b>
              </Row>
              <Row>
        ...
        <Row style={{textAlign : "center", margin : "2em 0"}}>
          <Button className="ant-btn-primary ant-card-hoverable" onClick={() => props.history.push('/exam/part7intro')}>Next</Button>
        </Row>
      </div>
    </div>
  </div>
