              ...
              return (
                <div>
                  <Row style={{ textAlign: 'center', margin: '2em 0' }}>
                    Question {71 + 3 * i} - {71 + 3 * i + 2} refer to following
                    conversation:
                  </Row>
                  <Row style={{ textAlign: 'center' }}>
                    {checked && (
                  ...
                  <Row>
                    <b>
                      {71 + 3 * i}. {data.subQuestions[0].question}
                    </b>
                  </Row>
                  <Row>
                    <Radio.Group
                  ...
                  <Row>
                    <b>
                      {71 + 3 * i + 1}. {data.subQuestions[1].question}
                    </b>
                  </Row>
                  <Row>
                    <Radio.Group
                  ...
                  <Row>
                    <b>
                      {71 + 3 * i + 2}. {data.subQuestions[2].question}
                    </b>
                  </Row>
                  <Row>
                    <Radio.Group
            ...
            <Button
              ...
              onClick={() => {
                ...
                services.submitResults(object).then(res => {
                  console.log(res);
                  props.history.push(
                    '/exam/part5intro?id=' + props.location.search.substring(4),
                  );
                });
                // props.history.push('/exam/part2intro?id=' + props.location.search.substring(4));
              }}
