                ...
                <thead>
                  <tr style={{height : "3em"}}>
                    <th colSpan="2" style={{color: "#D93425"}}>
                        Listening: {result[0] + result[1] + result[2] + result[3]}/100
                    </th>
                    <th  style={{width : "15%"}}>
                        Kỳ vọng
                    </th>
                    ...
                    <th className="right-answer" style={{color: "#D93425",width : "15%"}}>Điểm nghe: {pointListening[result[0] + result[1] + result[2] + result[3]]}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className=""><b>{target[1]}</b></td>
                    <td className="">{result[1] < target[1] &&
                  ...
                  <tr>
                    ...
                    <td className=""><b>{target[2]}</b></td>
                    <td className="">{result[2] < target[2] &&
                  ...
                  <tr>
                    ...
                    <td className=""><b>{target[3]}</b></td>
                    <td className="">{result[3] < target[3] &&
              ...
              <table className="table-question" style={{border: "none"}}>
                <thead>
                  <tr style={{height : "3em"}}>
                    ...
                    <th className="right-answer" style={{color: "#D93425",width : "15%"}}>Điểm đọc: {pointReading[result[4] + result[5] + result[6]]}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className=""><b>{target[4]}</b></td>
                    <td className="">{result[4] < target[4] &&
                  ...
                  <tr>
                    ...
                    <td className=""><b>{target[5]}</b></td>
                    <td className="">{result[5] < target[5] &&
                  ...
                  <tr>
                    ...
                    <td className=""><b>{target[6]}</b></td>
                    <td className="">{result[6] < target[6] &&
