              ...
              <table className="table-question" style={{border: "none"}}>
                <thead>
                  <tr style={{height : "3em"}}>
                    ...
                    <th className="right-answer" style={{color: "#D93425"}}>Điểm nghe: {pointListening[result[0] + result[1] + result[2] + result[3]]}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
              ...
              <table className="table-question" style={{border: "none"}}>
                <thead>
                  <tr style={{height : "3em"}}>
                    ...
                    <th className="right-answer" style={{color: "#D93425"}}>Điểm đọc: {pointReading[result[4] + result[5] + result[6]]}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
